...
if b1:
    ...
    with col6:
        st.write("Âm thanh")
        audio = open('d:/python/web/python4/cat.mp3','rb')
    ...
    with col7:
        image = 'd:/python/web/python4/cat.jpg'
...
if b2:
    ...
    with col6:
        st.write("Âm thanh")
        audio = open('d:/python/web/python4/dog.mp3','rb')
        st.audio(audio,format = 'audio/mp3')
        ...
        st.video(video,format = 'video/mp4')
    with col7:
        image = 'd:/python/web/python4/dog.jpg'
        st.image(image,caption = "Con chó")
if b3:
   
    with col6:
        st.write("Âm thanh")
        audio = open('d:/python/web/python4/monkey.mp3','rb')
        st.audio(audio,format = 'audio/mp3')
        ...
        st.video(video,format = 'video/mp4')
    with col7:
        image = 'd:/python/web/python4/monkey.jpg'
        st.image(image,caption = "Con khỉ")
if b4:
    with col6:
        st.write("Âm thanh")
        audio = open('d:/python/web/python4/eagle.mp3','rb')
        st.audio(audio,format = 'audio/mp3')
        ...
        st.video(video,format = 'video/mp4')
    with col7:
        image = 'd:/python/web/python4/eagle.jpg'
        st.image(image,caption = "Đại bàng")
if b5:
    with col6:
        st.write("Âm thanh")
        audio = open('d:/python/web/python4/chicken.mp3','rb')
        st.audio(audio,format = 'audio/mp3')
        ...
        st.video(video,format = 'video/mp4')
    with col7:
        image = 'd:/python/web/python4/chicken.jpg'
